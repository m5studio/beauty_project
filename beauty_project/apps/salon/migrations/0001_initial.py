# Generated by Django 3.1.1 on 2020-09-22 08:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metro_station', models.CharField(max_length=255, verbose_name='Станция метро')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='salon.city', verbose_name='Город')),
                ('metro', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='salon.metro', verbose_name='Метро')),
            ],
            options={
                'verbose_name': 'Адрес',
